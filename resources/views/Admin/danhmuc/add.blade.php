                    ...
                    <form action="/admin/danhmuc/add/store" method="POST" id="quickForm" novalidate="novalidate">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="MaDM" class="form-control" id="MaDM" placeholder="Mã danh mục">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Tên danh mục</label>
                                <input type="text" name="TenDM" class="form-control" id="TenDM" placeholder="Tên danh mục">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="ViTri" class="form-control" id="ViTri" placeholder="Vị trí">
                            </div>
